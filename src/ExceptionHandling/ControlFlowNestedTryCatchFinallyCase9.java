...
public class ControlFlowNestedTryCatchFinallyCase9 {
...
//Case9: If exception is raised at stmt 8 & corresponding catch block  matched then which line will be executed?
//Ans: Stmt 1,2,3,X,X,X,X,10,11 &12 will be executed followed by normal termination message
...
//  Outer-catch block will  get executed as exception raised in inner finally  matches with outer catch
//Outer finally will be executed
// Remaining line of code stmt 12  will get executed & normal Termination

//OUTPUT IS stmt1,2,3,4,5,10,11, &12
